local Ban = { -- sistema de ban by: fono obs: davikz144 passou por aqui :D
	['Ban'] = { 
	...
	['Ban_Amigos'] = {
		...
		[] = {Motivo = "Comprovante falso."}, -- comprovante falso
		[] = {Motivo = "Flw"}, 
		[] = {Motivo = "roblox negativo"}, -- trolando fingindo compra
		[] = {Motivo = "Fracassado."}, 
		[] = {Motivo = "flw"}, -- retardado xingando dc
		[] = {Motivo = "flw"}, -- retardado xingando dc
		[] = {Motivo = "flw"}, --  pedrinhouuuuuuu
		[] = {Motivo = "flw"}, --  all -99999
		[] = {Motivo = "flw"},
		[] = {Motivo = "flw"}, -- conta fake instagram
		[] = {Motivo = "Fracassado."}, 
		[] = {Motivo = "flw"}, -- ofensa a adm
		[] = {Motivo = "Flw"}, --  change abc
		[] = {Motivo = "flw"}, --   spam de r6 all
		[] = {Motivo = "flw"}, -- querendo atenção dc xingando uriel
		[] = {Motivo = "flw"}, -- level 949 no v2
		[] = {Motivo = "flw"}, -- ofendendo os membros do meu time
		[] = {Motivo = "flw"}, -- raidando torneio
		[] = {Motivo = "flw"}, --   change abc
		[] = {Motivo = "flw"}, --   change abc
		[] = {Motivo = "flw"}, --   AMIGOS DO IDK
		[] = {Motivo = "flw"}, --   ban all
		[] = {Motivo = "Fracassado"}, --   exploit / comandos all 
		[] = {Motivo = "Flw"}, --   Ban all nuke all, iarley que foi pro p3u
		[] = {Motivo = "ninguém gosta de você"}, --   alguém dando gameban all
		[] = {Motivo = "ninguém gosta de você."}, --   flw fono vou pro eb do p3u / mandy fingindo que iria comprar pra tomar desban
		[] = {Motivo = "Ninguém gosta de você."}, --  ban others
		[] = {Motivo = "ninguém gosta de você"}, --  troll usando starterscript
		[] = {Motivo = "ninguém gosta de você"}, --  troll usando starterscript
		[] = {Motivo = "flw"}, -- me acusando de crimes?
		[] = {Motivo = "Exploit"}, -- Spam exploit
		[] = {Motivo = "troll"}, -- van all destroiu v3 btools
	},
